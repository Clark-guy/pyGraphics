...
def randHillTops():
    ...
    def selPoint(xmin,xmax,ymin,ymax):
        i = r.randrange(xmin,xmax)
        j = r.randrange(ymin,ymax)
        return Point(i,j)
    #create hills, mts
    for x in range(r.randrange(4,12)):
        i = r.randrange(0,300)
        j = 300-r.randrange(30, 170)
        jlopez = 300-r.randrange(20,50)
        pt = Point(i,j)
